...
cv2.imshow('sdfsdsdfsddsfsddf' ,bitwise_img)
cv2.waitKey(0)
...
res = text[0][-2]
label = cv2.putText(img, res, (x1, y2 + 60), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 2)
label = cv2.rectangle(img, (y1, x2), (y2, x1), (0, 255, 0), 2)
